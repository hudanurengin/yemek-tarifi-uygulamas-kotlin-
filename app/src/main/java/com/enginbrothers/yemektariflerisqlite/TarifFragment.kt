package com.enginbrothers.yemektariflerisqlite
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if(gelenBilgi.equals("menudengeldim")){
                ...
                yemekIMalzemeText.setText("")
                button.visibility=View.VISIBLE

                val gorselSecmeArkaPlani= BitmapFactory.decodeResource(context?.resources,R.drawable.secimfoto)
                ...
                context?.let {
                    try {
                        ...
                        while(cursor.moveToNext()){
                            ...
                            yemekIMalzemeText.setText(cursor.getString(yemekMalzemeIndex))
    ...
    fun kaydet(view: View){
        ...
        val yemekMalzemeleri=yemekIMalzemeText.text.toString()
...
//bitmapi veriye çevirmek için gerekli kodlar
            try{
                context?.let{
